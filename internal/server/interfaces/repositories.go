...
type BinariesRepository interface {
	Get(ctx context.Context, title string) (*models.BinaryData, error)
...
type PasswordsRepository interface {
	Get(ctx context.Context, title string) (*models.Password, error)
...
type CardsRepository interface {
	Get(ctx context.Context, title string) (*models.Card, error)
